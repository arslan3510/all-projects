...
for x in li:
    ...
    print(x)
    ------------------------------------------------------------------
2 # second same programe use while looop 
...
for i in ls1:
    if "a" in i:
        ls2.append(i)
print(ls2)
# second same short programe
ls3 =[i for i in ls1 if "a" in i]
print(ls3)

# same programe
list1 = ["apple", "Banana", "cherry", "gava"]
list2 = []
for i in list1:
    if "a" in i:
        list2.append(i)
...
# second same short programe 
list3 = [i for i in list1 if "a" in i]
print(list3)
